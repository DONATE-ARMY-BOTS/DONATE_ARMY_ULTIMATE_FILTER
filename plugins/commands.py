...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('• ᴍᴀsᴛᴇʀ •', url="https://t.me/DONATE_OWNER_BOT"),
                    InlineKeyboardButton('• sᴜᴘᴘᴏʀᴛ •', url='https://t.me/DONATE_ARMY_BOTS_CHAT_GROUP')
                ],[
                    InlineKeyboardButton('• ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ •', url="https://t.me/DONATE_ARMY_BOTS")
                  ]]
    ...
    if len(message.command) == 2 and message.command[1] in ["premium"]:
        buttons = [[
                    InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(6796322067))
                  ],[
...
async def log_file(bot, message):
    """Send log file"""
    try:
        await message.reply_document('DONATE_ARMY BOT.LOG')
    except Exception as e:
...
async def donate_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("• ᴅᴏɴᴀᴛᴇ • ", url="https://telegra.ph/file/14c09b484953c56ccb6fb.jpg"),
            InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ •", url="https://t.me/+TEOLVuOuPl01Y2U1")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def help_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("• ᴏᴘᴇɴ ɪɴ ᴘʀɪᴠᴀᴛᴇ •", url="https://t.me/DONATE_ARMY_ULTIMATE_FILTER_BOT?start=help"),
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def support_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/+TEOLVuOuPl01Y2U1"),
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/DONATE_ARMY_BOTS")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
